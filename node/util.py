...
def bound_generator(data, index, bounds, circular):
    ...
    #print("Input <-", bounds, circular, index)
    ...
    if circular:
        ...
        #Subsequent classical cicular splits
            ...
            return [[data[index[0]], bounds[0][1]]], [[bounds[0][0], data[index[0]]]]
        ...
        if index[1] is None:
            ...
            return get_outter((-np.inf, data[index[0]]), bounds[0]), get_inner((-np.inf, data[index[0]]), bounds[0])
